                ...
                @csrf
                      <div class="roww">
                        ...
                        <div class="input-groupp input-groupp-icon">
                          <input type="text" placeholder="رقم الجلسة  " name="tr_course_session_arrangement" class="@error('tr_course_session_arrangement') is-invalid @enderror"/>
                          <div class="input-icon"><i class="fa-sharp fa-solid fa-calendar-week"></i></div>
                          @error('tr_course_session_arrangement')
                      ...
                      @enderror
                        ...
                        <div class="input-groupp input-groupp-icon">
                          <input type="text" placeholder="تاريخ الجلسة  " name="tr_course_session_date" class="@error('tr_course_session_date') is-invalid @enderror"/>
                          <div class="input-icon"><i class="fa-sharp fa-solid fa-calendar-week"></i></div>
