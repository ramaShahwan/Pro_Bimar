            ...
            <div class="col-lg-12">
                <div class="card">
                        <div class="card-header" style="text-align: start;font-size: 20px;display: flex;justify-content: space-between;align-items: center;">
                            <h3> <i class="las la-home"></i><i class="las la-angle-left"></i><i class="las la-laptop"></i></h3>
                            ...
                            <tbody style="text-align: center;">
                                ...
                                <td><i class="fa-solid fa-folder"></i> </td>
                                    ...
                                    <td>
                                        ...
                                        <a href="{{ route('questionbank') }}" class="btn btn-sm" style="color: #686363; border-color: #686363;">open</a>
