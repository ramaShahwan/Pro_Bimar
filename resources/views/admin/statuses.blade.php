            ...
            <div class="col-lg-12">
                <div class="card">
                        <div class="card-header" style="text-align: start;font-size: 20px;display: flex;justify-content: space-between;align-items: center;">
                            <h3><i class="fa-sharp fa-solid fa-calendar-week"></i>  حالات المستخدم</h3>
                            <!-- <a href="add.html" style="background: #007bff;padding: 6px;color: white;"><i class="las la-user-plus"></i> مدرب جديد</a> -->
                            <button onclick="togglePopuo()" class="bbtn">اضافة حالة </button>
                        </div>
...
<td>{{$call->tr_users_status_desc}}</td>
        ...
        <div class="popup" id="popup-1">
            ...
            <div class="content">
                ...
                <form action="{{url('status/store')}}" method="post" enctype="multipart/form-data">
                @csrf
                      <div class="roww">
                        <h4> حالة مستخدم جديدة </h4>
